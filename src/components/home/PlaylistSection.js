...
const recordingPlaylistData = {
  ...
  tracks: [
    ...
    { id: 2, title: 'My Dream (Video)', artist: '박노래', album: '월말평가', duration: '0:30', src: 'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', coverArt: 'https://peach.blender.org/wp-content/uploads/title_anouncement.jpg?x11217', type: 'audio' },
